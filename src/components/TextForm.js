    ...
    return (
        ...
        <div className="container" style={{color: props.mode === "dark"?"white":"black"}}>
           ...
           <div className="mb-3">
            ...
            {/* <textarea className="form-control" style={{backgroundColor: props.mode === "dark"?"grey":"white" ,color: props.mode === "dark"?"white":"black"}} placeholder="Enter text here..."  value={text} onChange={handelOnChange} id="myBox" rows="8"></textarea>  */}
            </div>
